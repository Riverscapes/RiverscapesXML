...
<qgis styleCategories="Symbology|Legend" version="3.22.3-Białowieża">
  <renderer-v2 forceraster="0" enableorderby="0" type="categorizedSymbol" symbollevels="0" attr="structure_source_id" referencescale="-1">
    <categories>
      <category label="Natural" value="1" render="true" symbol="0"/>
      <category label="Artificial" value="2" render="true" symbol="1"/>
      <category label="Unknown" value="3" render="true" symbol="2"/>
      ...
      <symbol alpha="1" name="0" type="marker" clip_to_extent="1" force_rhr="0">
        ...
        <layer class="SimpleMarker" pass="0" enabled="1" locked="0">
          <Option type="Map">
            ...
            <Option name="color" type="QString" value="90,212,226,255"/>
      ...
      <symbol alpha="1" name="1" type="marker" clip_to_extent="1" force_rhr="0">
        ...
        <layer class="SimpleMarker" pass="0" enabled="1" locked="0">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
            <Option name="color" type="QString" value="155,109,230,255"/>
            <Option name="horizontal_anchor_point" type="QString" value="1"/>
            <Option name="joinstyle" type="QString" value="bevel"/>
            <Option name="name" type="QString" value="circle"/>
            <Option name="offset" type="QString" value="0,0"/>
          ...
          <prop v="0" k="angle"/>
          <prop v="square" k="cap_style"/>
          <prop v="155,109,230,255" k="color"/>
          <prop v="1" k="horizontal_anchor_point"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="circle" k="name"/>
          <prop v="0,0" k="offset"/>
