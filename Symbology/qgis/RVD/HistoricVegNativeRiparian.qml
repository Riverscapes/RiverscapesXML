...
<qgis hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" version="3.16.8-Hannover" minScale="0" maxScale="0">
  ...
  <pipe>
    ...
    <rasterrenderer alphaBand="-1" opacity="0.8" nodataColor="" band="1" type="paletted">
      <minMaxOrigin>
        <limits>None</limits>
      ...
      <colorPalette>
        <paletteEntry alpha="255" value="1" color="#267300" label="Native Riparian"/>
        <paletteEntry alpha="0" value="0" color="#f0f0f0" label="Non Native-Riparian"/>
      </colorPalette>
    </rasterrenderer>
