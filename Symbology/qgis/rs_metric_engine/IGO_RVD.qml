...
<qgis labelsEnabled="0" hasScaleBasedVisibilityFlag="0" readOnly="0" version="3.22.11-Białowieża" simplifyAlgorithm="0" simplifyDrawingTol="1" maxScale="0" simplifyLocal="1" styleCategories="AllStyleCategories" symbologyReferenceScale="-1" simplifyDrawingHints="0" minScale="100000000" simplifyMaxScale="1">
  ...
  <renderer-v2 enableorderby="0" symbollevels="0" referencescale="-1" type="RuleRenderer" forceraster="0">
    <rules key="{3f8bd87d-f629-4f45-9811-d1ba010603d9}">
      <rule symbol="0" label="Large: > 6%" filter="&quot;rcat_igo_riparian_veg_departure&quot; > 0.66" key="{9830baa9-f0cf-4777-99f8-d7586711e5d5}"/>
      <rule symbol="1" label="Significant: 33% to 66%" filter="&quot;rcat_igo_riparian_veg_departure&quot; > 0.33 and &quot;rcat_igo_riparian_veg_departure&quot; &lt;= 0.66" key="{faf4385e-ebf4-4a79-99f6-56547a4131cc}"/>
      <rule symbol="2" label="Minor: 10% to 33%" filter="&quot;rcat_igo_riparian_veg_departure&quot; > 0.1 and &quot;rcat_igo_riparian_veg_departure&quot; &lt;= 0.33" key="{ce87a04b-88e6-49bb-af94-7a7592fd956f}"/>
      <rule symbol="3" label="Negligible: &lt; 10%" filter="(&quot;rcat_igo_riparian_veg_departure&quot; &lt;= 0.1) or (&quot;anthro_igo_land_use_intens&quot; = 0)" key="{7043f014-d2d3-47c3-97d8-b5a9fe16408f}"/>
    </rules>
    <symbols>
      ...
      <symbol clip_to_extent="1" alpha="1" force_rhr="0" name="2" type="marker">
        ...
        <layer pass="0" class="SimpleMarker" enabled="1" locked="0">
          <Option type="Map">
            <Option value="0" name="angle" type="QString"/>
            <Option value="square" name="cap_style" type="QString"/>
            <Option value="148,247,0,255" name="color" type="QString"/>
            <Option value="1" name="horizontal_anchor_point" type="QString"/>
            <Option value="bevel" name="joinstyle" type="QString"/>
            <Option value="circle" name="name" type="QString"/>
            <Option value="0,0" name="offset" type="QString"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column hidden="0" width="424" name="vbet_igo_integrated_width" type="field"/>
