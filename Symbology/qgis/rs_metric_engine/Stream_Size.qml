...
<qgis labelsEnabled="0" symbologyReferenceScale="-1" styleCategories="AllStyleCategories" simplifyMaxScale="1" maxScale="0" version="3.22.11-Białowieża" simplifyDrawingTol="1" simplifyLocal="1" minScale="100000000" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" readOnly="0" simplifyDrawingHints="0">
  ...
  <renderer-v2 type="categorizedSymbol" forceraster="0" symbollevels="0" enableorderby="0" attr="stream_size" referencescale="-1">
    <categories>
      <category render="true" value="0" symbol="0" label="Small (0)"/>
      <category render="true" value="1" symbol="1" label="Medium (1)"/>
      <category render="true" value="2" symbol="2" label="Large (2)"/>
    </categories>
    <symbols>
      <symbol type="marker" clip_to_extent="1" alpha="1" force_rhr="0" name="0">
        ...
        <layer class="SimpleMarker" locked="0" pass="0" enabled="1">
          <Option type="Map">
            ...
            <Option type="QString" value="88,87,70,255" name="color"/>
      ...
      <symbol type="marker" clip_to_extent="1" alpha="1" force_rhr="0" name="2">
        ...
        <layer class="SimpleMarker" locked="0" pass="0" enabled="1">
          <Option type="Map">
            <Option type="QString" value="0" name="angle"/>
            <Option type="QString" value="square" name="cap_style"/>
            <Option type="QString" value="74,73,130,255" name="color"/>
            <Option type="QString" value="1" name="horizontal_anchor_point"/>
            <Option type="QString" value="bevel" name="joinstyle"/>
            <Option type="QString" value="circle" name="name"/>
            <Option type="QString" value="0,0" name="offset"/>
    ...
    <colorramp type="gradient" name="[source]">
      <Option type="Map">
        <Option type="QString" value="88,87,70,255" name="color1"/>
        <Option type="QString" value="74,73,130,255" name="color2"/>
        <Option type="QString" value="0" name="discrete"/>
        <Option type="QString" value="gradient" name="rampType"/>
      </Option>
      <prop k="color1" v="88,87,70,255"/>
      <prop k="color2" v="74,73,130,255"/>
      <prop k="discrete" v="0"/>
