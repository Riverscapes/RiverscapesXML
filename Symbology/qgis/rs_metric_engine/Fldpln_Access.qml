...
<qgis labelsEnabled="0" hasScaleBasedVisibilityFlag="0" readOnly="0" version="3.22.11-Białowieża" simplifyAlgorithm="0" simplifyDrawingTol="1" maxScale="0" simplifyLocal="1" styleCategories="AllStyleCategories" symbologyReferenceScale="-1" simplifyDrawingHints="0" minScale="100000000" simplifyMaxScale="1">
  ...
  <renderer-v2 enableorderby="0" symbollevels="0" referencescale="-1" type="RuleRenderer" forceraster="0">
    <rules key="{7c6f27d0-3059-44db-a3d1-38e61d83de97}">
      <rule symbol="0" label="&lt; 50%" filter="&quot;rcat_igo_fldpln_access&quot; &lt; 0.5" key="{15a918ae-882c-445c-9ec0-4cdd3bc6a222}"/>
      <rule symbol="1" label="50 - 75% " filter="&quot;rcat_igo_fldpln_access&quot; >= 0.5 and &quot;rcat_igo_fldpln_access&quot; &lt; 0.75" key="{2b6e7533-6a8a-4e73-b114-67365f7c978b}"/>
      <rule symbol="2" label="75 - 90% " filter="&quot;rcat_igo_fldpln_access&quot; >= 0.75 and &quot;rcat_igo_fldpln_access&quot; &lt; 0.9" key="{0cf3300e-189b-4cb4-b818-e6ade97c4faf}"/>
      <rule symbol="3" label="90 - 95% " filter="&quot;rcat_igo_fldpln_access&quot; >= 0.9 and &quot;rcat_igo_fldpln_access&quot; &lt; 0.95" key="{5d8b77c6-1b7f-4d06-b9e9-1aa7996a1fcc}"/>
      <rule symbol="4" label="> 95%" filter="&quot;rcat_igo_fldpln_access&quot; >= 0.95" key="{2a6467e4-99b6-4c57-88c4-127bbe6430cb}"/>
    </rules>
    <symbols>
      ...
      <symbol clip_to_extent="1" alpha="1" force_rhr="0" name="3" type="marker">
        ...
        <layer pass="0" class="SimpleMarker" enabled="1" locked="0">
          ...
          <prop k="angle" v="0"/>
          <prop k="cap_style" v="square"/>
          <prop k="color" v="161,114,239,255"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="name" v="circle"/>
          <prop k="offset" v="0,0"/>
