...
<qgis labelsEnabled="0" hasScaleBasedVisibilityFlag="0" readOnly="0" version="3.22.11-Białowieża" simplifyAlgorithm="0" simplifyDrawingTol="1" maxScale="0" simplifyLocal="1" styleCategories="AllStyleCategories" symbologyReferenceScale="-1" simplifyDrawingHints="0" minScale="100000000" simplifyMaxScale="1">
  ...
  <renderer-v2 enableorderby="0" symbollevels="0" referencescale="-1" type="RuleRenderer" forceraster="0">
    <rules key="{2f510374-0267-4d77-9a23-e38973aad65e}">
      <rule symbol="0" label="High" filter="&quot;anthro_igo_land_use_intens&quot; > 66" key="{850a31de-e611-478c-860c-8916d165dd93}"/>
      <rule symbol="1" label="Moderate" filter="&quot;anthro_igo_land_use_intens&quot; > 33 and &quot;anthro_igo_land_use_intens&quot; &lt;= 66" key="{72a8fb12-6425-421c-a53a-e2e2dcc54369}"/>
      <rule symbol="2" label="Low" filter="&quot;anthro_igo_land_use_intens&quot; > 0 and &quot;anthro_igo_land_use_intens&quot; &lt;= 33" key="{0a4f6ad0-78fa-4266-a257-0ead49d72831}"/>
      <rule symbol="3" label="Very Low" filter="&quot;anthro_igo_land_use_intens&quot; = 0" key="{9a1b9b59-1911-4799-8008-c4bd8d7384e3}"/>
    </rules>
    <symbols>
      ...
      <symbol clip_to_extent="1" alpha="1" force_rhr="0" name="1" type="marker">
        ...
        <layer pass="0" class="SimpleMarker" enabled="1" locked="0">
          <Option type="Map">
            <Option value="0" name="angle" type="QString"/>
            <Option value="square" name="cap_style" type="QString"/>
            <Option value="255,187,0,255" name="color" type="QString"/>
            <Option value="1" name="horizontal_anchor_point" type="QString"/>
            <Option value="bevel" name="joinstyle" type="QString"/>
            <Option value="circle" name="name" type="QString"/>
            <Option value="0,0" name="offset" type="QString"/>
      ...
      <symbol clip_to_extent="1" alpha="1" force_rhr="0" name="2" type="marker">
        ...
        <layer pass="0" class="SimpleMarker" enabled="1" locked="0">
          <Option type="Map">
            <Option value="0" name="angle" type="QString"/>
            <Option value="square" name="cap_style" type="QString"/>
            <Option value="164,196,0,255" name="color" type="QString"/>
            <Option value="1" name="horizontal_anchor_point" type="QString"/>
            <Option value="bevel" name="joinstyle" type="QString"/>
            <Option value="circle" name="name" type="QString"/>
            <Option value="0,0" name="offset" type="QString"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column hidden="0" width="428" name="anthro_igo_land_use_intens" type="field"/>
