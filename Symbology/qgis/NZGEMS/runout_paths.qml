...
<qgis styleCategories="Symbology" version="3.40.5-Bratislava">
  ...
  <pipe>
    ...
    <rasterrenderer type="paletted" opacity="0.8" nodataColor="" alphaBand="-1" band="1">
      ...
      <colorPalette>
        <paletteEntry value="1" color="#4d4def" label="More Likely, small short runouts" alpha="255"/>
        <paletteEntry value="2" color="#13de13" label="Less Likely" alpha="255"/>
        <paletteEntry value="3" color="#dc1010" label="Least Likely, large long runouts" alpha="255"/>
      </colorPalette>
