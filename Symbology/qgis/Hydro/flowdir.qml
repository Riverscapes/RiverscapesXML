...
<qgis maxScale="0" hasScaleBasedVisibilityFlag="0" version="3.28.3-Firenze" minScale="0" styleCategories="AllStyleCategories">
  ...
  <pipe>
    ...
    <rasterrenderer alphaBand="-1" band="1" classificationMax="180" classificationMin="-179.99427795410156" nodataColor="" opacity="1" type="singlebandpseudocolor">
      <minMaxOrigin>
        <limits>None</limits>
      ...
      <rastershader>
        <colorrampshader classificationMode="1" clip="0" maximumValue="180" minimumValue="-179.99427795410156" labelPrecision="6" colorRampType="DISCRETE">
          <colorramp name="[source]" type="gradient">
            <Option type="Map">
              ...
              <Option value="0.5;255,255,0,255;rgb;ccw" name="stops" type="QString"/>
            </Option>
          </colorramp>
          <item label="SW - S" color="#006100" alpha="255" value="-135"/>
          <item label="W - SW" color="#498a00" alpha="255" value="-90"/>
          <item label="NW - W" color="#8bb500" alpha="255" value="-45"/>
          <item label="NW - N" color="#d6e600" alpha="255" value="0"/>
          <item label="N - NE" color="#ffe600" alpha="255" value="45"/>
          <item label="NE - E" color="#ffa600" alpha="255" value="90"/>
          <item label="E - SE" color="#ff6f00" alpha="255" value="135"/>
          <item label="SE - S" color="#ff2200" alpha="255" value="180"/>
