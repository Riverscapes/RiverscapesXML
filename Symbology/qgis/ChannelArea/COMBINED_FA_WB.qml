...
<qgis version="3.18.2-Zürich" simplifyAlgorithm="0" simplifyDrawingTol="1" minScale="100000000" labelsEnabled="0" simplifyLocal="1" simplifyMaxScale="1" readOnly="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" maxScale="0">
      ...
      <symbol alpha="1" force_rhr="0" name="0" type="fill" clip_to_extent="1">
        ...
        <layer class="SimpleFill" locked="0" enabled="1" pass="0">
          <Option type="Map">
            ...
            <Option name="color" type="QString" value="142,180,240,255"/>
          ...
          <prop v="142,180,240,255" k="color"/>
  ...
  <aliases>
    ...
    <alias field="ReachCode" name="" index="8"/>
    <alias field="FType" name="" index="9"/>
    <alias field="FCode" name="" index="10"/>
    <alias field="Visibility" name="" index="11"/>
    <alias field="Shape_Leng" name="" index="12"/>
    <alias field="Shape_Area" name="" index="13"/>
    <alias field="NHDPlusID" name="" index="14"/>
    <alias field="VPUID" name="" index="15"/>
  </aliases>
  <defaults>
