...
<qgis maxScale="0" styleCategories="AllStyleCategories" simplifyLocal="1" version="3.16.8-Hannover" simplifyAlgorithm="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" minScale="100000000" labelsEnabled="1" simplifyDrawingHints="1" simplifyDrawingTol="1" readOnly="0">
    ...
    <symbols>
      <symbol force_rhr="0" clip_to_extent="1" type="fill" alpha="1" name="0">
        <layer enabled="1" pass="0" locked="0" class="SimpleFill">
          ...
          <prop v="230,0,0,255" k="outline_color"/>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="HUC8">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias index="11" field="HUC8" name=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="HUC8" notnull_strength="0" exp_strength="0" constraints="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" field="HUC8" exp=""/>
  ...
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column hidden="0" type="field" width="-1" name="HUC8"/>
    </columns>
