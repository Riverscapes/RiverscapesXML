  ...
  <elevation band="1" symbology="Line" zscale="1" enabled="0" zoffset="0">
    ...
    <profileLineSymbol>
      <symbol force_rhr="0" name="" clip_to_extent="1" frame_rate="10" alpha="1" is_animated="0" type="line">
        ...
        <layer pass="0" class="SimpleLine" id="{606fa735-77fc-4322-8694-fa184dc714ea}" locked="0" enabled="1">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol force_rhr="0" name="" clip_to_extent="1" frame_rate="10" alpha="1" is_animated="0" type="fill">
        ...
        <layer pass="0" class="SimpleFill" id="{e1465cab-c611-4a0b-b577-35edad0a25db}" locked="0" enabled="1">
          <Option type="Map">
  ...
  <pipe>
    ...
    <rasterrenderer opacity="1" band="1" alphaBand="-1" type="paletted" nodataColor="">
      ...
      <colorPalette>
        ...
        <paletteEntry alpha="255" label="Succession Class A" value="1" color="#a16333"/>
        <paletteEntry alpha="255" label="Succession Class B" value="2" color="#38a800"/>
        <paletteEntry alpha="255" label="Succession Class C" value="3" color="#c9deab"/>
        <paletteEntry alpha="255" label="Succession Class D" value="4" color="#fff8a6"/>
        <paletteEntry alpha="255" label="Succession Class E" value="5" color="#004a4d"/>
        <paletteEntry alpha="255" label="Uncharacteristic Native Vegetation Cover/Structure/Composition" value="6" color="#a00000"/>
        <paletteEntry alpha="255" label="Uncharacteristic Exotic Vegetation" value="7" color="#ff0000"/>
        <paletteEntry alpha="255" label="Water" value="111" color="#0000ff"/>
        <paletteEntry alpha="255" label="Snow/Ice" value="112" color="#9fa1f0"/>
        <paletteEntry alpha="255" label="Developed" value="120" color="#84008a"/>
