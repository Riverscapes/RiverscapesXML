...
<qgis maxScale="0" styleCategories="AllStyleCategories" simplifyLocal="1" version="3.16.8-Hannover" simplifyAlgorithm="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" minScale="100000000" labelsEnabled="1" simplifyDrawingHints="1" simplifyDrawingTol="1" readOnly="0">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style namedStyle="Regular" fontStrikeout="0" fontWordSpacing="0" fontUnderline="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" textColor="0,0,0,255" capitalization="0" fontWeight="50" fontSize="8" fontItalic="0" useSubstitutions="0" fieldName="Name +  '\n'  +  &quot;HUC10&quot; " fontLetterSpacing="0" textOrientation="horizontal" fontKerning="1" fontSizeUnit="Point" fontFamily="MS Shell Dlg 2" textOpacity="1" isExpression="1" allowHtml="0" blendMode="0" previewBkgrdColor="255,255,255,255" multilineHeight="1">
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="HUC10">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias index="11" field="HUC10" name=""/>
    <alias index="12" field="HUType" name=""/>
    <alias index="13" field="HUMod" name=""/>
    <alias index="14" field="Shape_Leng" name=""/>
    <alias index="15" field="Shape_Area" name=""/>
  </aliases>
  <defaults>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="HUC10" notnull_strength="0" exp_strength="0" constraints="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" field="HUC10" exp=""/>
  ...
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column hidden="0" type="field" width="-1" name="HUC10"/>
