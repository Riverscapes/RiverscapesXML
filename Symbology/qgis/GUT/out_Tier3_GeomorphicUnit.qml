...
<qgis simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" maxScale="0" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingHints="1" version="3.20.1-Odense" simplifyDrawingTol="1" minScale="0" labelsEnabled="0" readOnly="0" styleCategories="AllStyleCategories">
  ...
  <renderer-v2 enableorderby="0" symbollevels="0" forceraster="0" type="RuleRenderer">
    <rules key="{f0e463a2-3dcb-4696-a7a4-2ca25b8beffd}">
      <rule description="Geomorphic Unit" label="Geomorphic Unit" key="{b6b250b4-8786-4ed0-8e5b-9353998ece90}">
        <rule description="Bank" filter="GU = 'Bank'" label="Bank" key="{46ea6095-450c-4926-aa82-22b95389f894}" symbol="0"/>
        <rule description="Pool" filter="GU = 'Pool'" label="Pool" key="{7edc21b3-6f35-41d2-bbbe-2eadd61fb1f3}" symbol="1"/>
        <rule description="Pond" filter="GU = 'Pond'" label="Pond" key="{b339a4d3-f51f-4671-a34b-9a17fcefbd53}" symbol="2"/>
        <rule description="Pocket Pool" filter="GU = 'Pocket Pool'" label="Pocket Pool" key="{7abed3ff-e557-47ef-aa0e-6f291313e479}" symbol="3"/>
        <rule description="Chute" filter="GU = 'Chute'" label="Chute" key="{ca4390e2-7386-4de4-b269-2c71db540fb7}" symbol="4"/>
        <rule description="Rapid" filter="GU = 'Rapid'" label="Rapid" key="{07535fac-8c80-4bcd-8ef2-c872d0ce1159}" symbol="5"/>
        <rule description="Cascade" filter="GU = 'Cascade'" label="Cascade" key="{995ab0be-0374-44fb-a6fd-ec5c2abc91f7}" symbol="6"/>
        <rule description="Glide-Run" filter="GU = 'Glide-Run'" label="Glide-Run" key="{8454f49f-49f0-425b-9bab-111a0dc46a68}" symbol="7"/>
        <rule description="Riffle" filter="GU = 'Riffle'" label="Riffle" key="{5ce97a3e-adb0-4c31-9018-86d389803ad0}" symbol="8"/>
        <rule description="Step" filter="GU = 'Step'" label="Step" key="{4a5fe972-53c4-4fec-af1b-699ebc4e057e}" symbol="9"/>
        <rule description="Mid Channel Bar" filter="GU = 'Mid Channel Bar'" label="Mid Channel Bar" key="{92ecd5f4-e522-4bba-b600-db70f382d91f}" symbol="10"/>
        <rule description="Margin Attached Bar" filter="GU = 'Margin Attached Bar'" label="Margin Attached Bar" key="{b10680cb-6f17-4373-93fa-05ffaa979c1a}" symbol="11"/>
        <rule description="Barface" filter="GU = 'Barface'" label="Barface" key="{a0789fcb-22e3-4771-b1bc-c4d865bd2215}" symbol="12"/>
        <rule description="Transition" filter="GU = 'Transition'" label="Transition" key="{26ab5b28-b238-4bd7-8529-dcbc487bccab}" symbol="13"/>
      </rule>
      <rule checkstate="0" description="&lt;all other values>" filter="ELSE" label="&lt;all other values>" key="{6646e937-1a27-4c02-8a77-f671b03dc775}" symbol="14"/>
    </rules>
    <symbols>
      ...
      <symbol clip_to_extent="1" force_rhr="0" name="10" alpha="1" type="fill">
        ...
        <layer locked="0" enabled="1" pass="0" class="SimpleFill">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="color" type="QString" value="137,90,68,255"/>
            <Option name="joinstyle" type="QString" value="bevel"/>
            <Option name="offset" type="QString" value="0,0"/>
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="offset_unit" type="QString" value="MM"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" name="12" alpha="1" type="fill">
        ...
        <layer locked="0" enabled="1" pass="0" class="SimpleFill">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="color" type="QString" value="115,0,0,255"/>
            <Option name="joinstyle" type="QString" value="bevel"/>
            <Option name="offset" type="QString" value="0,0"/>
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="offset_unit" type="QString" value="MM"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" name="2" alpha="1" type="fill">
        ...
        <layer locked="0" enabled="1" pass="0" class="SimpleFill">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="color" type="QString" value="0,112,255,255"/>
            <Option name="joinstyle" type="QString" value="bevel"/>
            <Option name="offset" type="QString" value="0,0"/>
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="offset_unit" type="QString" value="MM"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" name="4" alpha="1" type="fill">
        ...
        <layer locked="0" enabled="1" pass="0" class="SimpleFill">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="color" type="QString" value="115,255,223,255"/>
            <Option name="joinstyle" type="QString" value="bevel"/>
            <Option name="offset" type="QString" value="0,0"/>
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="offset_unit" type="QString" value="MM"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" name="5" alpha="1" type="fill">
        ...
        <layer locked="0" enabled="1" pass="0" class="SimpleFill">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="color" type="QString" value="102,205,171,255"/>
            <Option name="joinstyle" type="QString" value="bevel"/>
            <Option name="offset" type="QString" value="0,0"/>
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="offset_unit" type="QString" value="MM"/>
          ...
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="color" v="102,205,171,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" name="6" alpha="1" type="fill">
        ...
        <layer locked="0" enabled="1" pass="0" class="SimpleFill">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="color" type="QString" value="68,137,112,255"/>
            <Option name="joinstyle" type="QString" value="bevel"/>
            <Option name="offset" type="QString" value="0,0"/>
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="offset_unit" type="QString" value="MM"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" name="9" alpha="1" type="fill">
        ...
        <layer locked="0" enabled="1" pass="0" class="SimpleFill">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="color" type="QString" value="215,176,158,255"/>
            <Option name="joinstyle" type="QString" value="bevel"/>
            <Option name="offset" type="QString" value="0,0"/>
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="offset_unit" type="QString" value="MM"/>
