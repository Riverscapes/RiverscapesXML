...
<qgis simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" maxScale="0" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingHints="1" version="3.20.1-Odense" simplifyDrawingTol="1" minScale="0" labelsEnabled="0" readOnly="0" styleCategories="AllStyleCategories">
  ...
  <renderer-v2 enableorderby="0" symbollevels="0" forceraster="0" type="RuleRenderer">
    <rules key="{11818c98-3b22-4a6f-94fd-aea1ad44ab0f}">
      <rule description="Unit Shape" label="Unit Shape" key="{f10004eb-8306-4ee8-bff6-7f8e8718e1bb}">
        <rule description="Concavity" filter="UnitShape = 'Concavity'" label="Concavity" key="{bb27fbb1-5d8f-4ad9-bae3-a6a6e5d6dded}" symbol="0"/>
        <rule description="Convexity" filter="UnitShape = 'Convexity'" label="Convexity" key="{5d7a19bc-19c0-41b6-ba5e-b30dba57e1a7}" symbol="1"/>
        <rule description="Planar" filter="UnitShape = 'Planar'" label="Planar" key="{188e4913-9f2a-436e-9662-5d8fae3acb75}" symbol="2"/>
      </rule>
      <rule checkstate="0" description="&lt;all other values>" filter="ELSE" label="&lt;all other values>" key="{ef2262b2-5fed-4dfc-a597-b6a18533e54c}" symbol="3"/>
    </rules>
    <symbols>
      <symbol clip_to_extent="1" force_rhr="0" name="0" alpha="1" type="fill">
        ...
        <layer locked="0" enabled="1" pass="0" class="SimpleFill">
          <Option type="Map">
            ...
            <Option name="color" type="QString" value="37,128,180,255"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" name="1" alpha="1" type="fill">
        ...
        <layer locked="0" enabled="1" pass="0" class="SimpleFill">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="color" type="QString" value="250,169,24,255"/>
            <Option name="joinstyle" type="QString" value="bevel"/>
            <Option name="offset" type="QString" value="0,0"/>
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="offset_unit" type="QString" value="MM"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" name="2" alpha="1" type="fill">
        ...
        <layer locked="0" enabled="1" pass="0" class="SimpleFill">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="color" type="QString" value="246,235,22,255"/>
            <Option name="joinstyle" type="QString" value="bevel"/>
            <Option name="offset" type="QString" value="0,0"/>
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="offset_unit" type="QString" value="MM"/>
