...
<qgis simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" maxScale="0" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingHints="1" version="3.20.1-Odense" simplifyDrawingTol="1" minScale="0" labelsEnabled="0" readOnly="0" styleCategories="AllStyleCategories">
  ...
  <renderer-v2 enableorderby="0" symbollevels="0" forceraster="0" type="RuleRenderer">
    <rules key="{202fd49b-27f1-4e0f-a155-6373d2700e33}">
      <rule description="Orient Category" label="Orient Category" key="{3c764f95-e9c1-4b44-ab7c-928351145347}">
        <rule description="Diagonal" filter="OrientCat = 'Diagonal'" label="Diagonal" key="{3e7f0538-ad31-4540-9ba4-482555712d2d}" symbol="0"/>
        <rule description="Longitudinal" filter="OrientCat = 'Longitudinal'" label="Longitudinal" key="{a87439f7-92a6-4bef-ad0d-f4c3c84a3a16}" symbol="1"/>
        <rule description="Transverse" filter="OrientCat = 'Transverse'" label="Transverse" key="{07f7bad5-350f-4fcf-afae-77a605981991}" symbol="2"/>
      </rule>
      <rule checkstate="0" description="&lt;all other values>" filter="ELSE" label="&lt;all other values>" key="{fc63c5b3-95ca-445e-acda-b6cd637b0d13}" symbol="3"/>
    </rules>
    <symbols>
      <symbol clip_to_extent="1" force_rhr="0" name="0" alpha="1" type="fill">
        ...
        <layer locked="0" enabled="1" pass="0" class="SimpleFill">
          <Option type="Map">
            ...
            <Option name="color" type="QString" value="250,250,100,255"/>
          ...
          <prop k="color" v="250,250,100,255"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" name="1" alpha="1" type="fill">
        ...
        <layer locked="0" enabled="1" pass="0" class="SimpleFill">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="color" type="QString" value="40,146,199,255"/>
            <Option name="joinstyle" type="QString" value="bevel"/>
            <Option name="offset" type="QString" value="0,0"/>
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="offset_unit" type="QString" value="MM"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" name="2" alpha="1" type="fill">
        ...
        <layer locked="0" enabled="1" pass="0" class="SimpleFill">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="color" type="QString" value="232,16,20,255"/>
            <Option name="joinstyle" type="QString" value="bevel"/>
            <Option name="offset" type="QString" value="0,0"/>
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="offset_unit" type="QString" value="MM"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style isExpression="1" fontWeight="16" fontItalic="0" fontWordSpacing="0" useSubstitutions="0" namedStyle="" multilineHeight="1" capitalization="0" fontSizeUnit="Point" textOpacity="1" allowHtml="0" legendString="Aa" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontUnderline="0" textColor="0,0,0,255" textOrientation="horizontal" fontFamily="Arial" fieldName="&quot;GU&quot;" fontKerning="1" fontSize="8" blendMode="0" previewBkgrdColor="255,255,255,255" fontLetterSpacing="0" fontStrikeout="0">
        <families/>
  ...
  <widgets/>
  <previewExpression>"GU"</previewExpression>
  <mapTip></mapTip>
