...
<qgis simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" maxScale="0" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingHints="1" version="3.20.1-Odense" simplifyDrawingTol="1" minScale="0" labelsEnabled="0" readOnly="0" styleCategories="AllStyleCategories">
  ...
  <renderer-v2 enableorderby="0" symbollevels="0" forceraster="0" type="RuleRenderer">
    <rules key="{88f02792-7b2b-4409-bea3-ae9c96263bf3}">
      <rule description="Unit Form" label="Unit Form" key="{2317c868-2b8e-4039-b885-012ce58d2a78}">
        <rule description="Bowl" filter="UnitForm = 'Bowl'" label="Bowl" key="{98f6bfab-b94e-4527-9adb-b76ba194fc43}" symbol="0"/>
        <rule description="Bowl Transition" filter="UnitForm = 'Bowl Transition'" label="Bowl Transition" key="{d53298ff-dc7a-4d76-a740-50b01c73bf3a}" symbol="1"/>
        <rule description="Trough" filter="UnitForm = 'Trough'" label="Trough" key="{9134e080-7bfa-4b07-b6c9-77de576b1b58}" symbol="2"/>
        <rule description="Plane" filter="UnitForm = 'Plane'" label="Plane" key="{a06cf9d9-c51a-44c8-ac7a-4654d548d378}" symbol="3"/>
        <rule description="Mound Transition" filter="UnitForm = 'Mound Transition'" label="Mound Transition" key="{437059f4-ec06-4c2b-87d4-6261bd1f178c}" symbol="4"/>
        <rule description="Saddle" filter="UnitForm = 'Saddle'" label="Saddle" key="{8cbd3748-a69d-40d0-adf1-105b28dc4153}" symbol="5"/>
        <rule description="Mound" filter="UnitForm = 'Mound'" label="Mound" key="{bf4c296d-b442-47d3-a564-254335d3c498}" symbol="6"/>
        <rule description="Wall" filter="UnitForm = 'Wall'" label="Wall" key="{0e3dcd92-3136-47c4-b905-e1be0dd72a4c}" symbol="7"/>
      </rule>
      <rule checkstate="0" description="&lt;all other values>" filter="ELSE" label="&lt;all other values>" key="{b504896a-1078-4762-bfb2-def037d430ea}" symbol="8"/>
    </rules>
    <symbols>
      <symbol clip_to_extent="1" force_rhr="0" name="0" alpha="1" type="fill">
        ...
        <layer locked="0" enabled="1" pass="0" class="SimpleFill">
          <Option type="Map">
            ...
            <Option name="color" type="QString" value="0,77,168,255"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" name="1" alpha="1" type="fill">
        ...
        <layer locked="0" enabled="1" pass="0" class="SimpleFill">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="color" type="QString" value="0,169,230,255"/>
            <Option name="joinstyle" type="QString" value="bevel"/>
            <Option name="offset" type="QString" value="0,0"/>
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="offset_unit" type="QString" value="MM"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" name="2" alpha="1" type="fill">
        ...
        <layer locked="0" enabled="1" pass="0" class="SimpleFill">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="color" type="QString" value="115,223,255,255"/>
            <Option name="joinstyle" type="QString" value="bevel"/>
            <Option name="offset" type="QString" value="0,0"/>
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="offset_unit" type="QString" value="MM"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" name="3" alpha="1" type="fill">
        ...
        <layer locked="0" enabled="1" pass="0" class="SimpleFill">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="color" type="QString" value="230,230,0,255"/>
            <Option name="joinstyle" type="QString" value="bevel"/>
            <Option name="offset" type="QString" value="0,0"/>
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="offset_unit" type="QString" value="MM"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" name="4" alpha="1" type="fill">
        ...
        <layer locked="0" enabled="1" pass="0" class="SimpleFill">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="color" type="QString" value="255,127,127,255"/>
            <Option name="joinstyle" type="QString" value="bevel"/>
            <Option name="offset" type="QString" value="0,0"/>
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="offset_unit" type="QString" value="MM"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" name="5" alpha="1" type="fill">
        ...
        <layer locked="0" enabled="1" pass="0" class="SimpleFill">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="color" type="QString" value="230,152,0,255"/>
            <Option name="joinstyle" type="QString" value="bevel"/>
            <Option name="offset" type="QString" value="0,0"/>
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="offset_unit" type="QString" value="MM"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" name="6" alpha="1" type="fill">
        ...
        <layer locked="0" enabled="1" pass="0" class="SimpleFill">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="color" type="QString" value="168,0,0,255"/>
            <Option name="joinstyle" type="QString" value="bevel"/>
            <Option name="offset" type="QString" value="0,0"/>
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="offset_unit" type="QString" value="MM"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" name="8" alpha="1" type="fill">
        ...
        <layer locked="0" enabled="1" pass="0" class="SimpleFill">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="color" type="QString" value="196,245,229,255"/>
            <Option name="joinstyle" type="QString" value="bevel"/>
            <Option name="offset" type="QString" value="0,0"/>
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="offset_unit" type="QString" value="MM"/>
          ...
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="color" v="196,245,229,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
