...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyMaxScale="1" simplifyDrawingHints="1" minScale="0" simplifyAlgorithm="0" maxScale="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" version="3.20.1-Odense" styleCategories="AllStyleCategories">
  ...
  <renderer-v2 forceraster="0" enableorderby="0" type="RuleRenderer" symbollevels="0">
    <rules key="{94a9ec1d-b576-4444-9f61-a30292af0625}">
      <rule label="Bed Slope SD Category" description="Bed Slope SD Category" key="{d991b3c5-8fc7-4e53-a925-41c65dfddd34}">
        <rule symbol="0" label="High" description="High" filter="GRIDCODE = '3'" key="{c9d90fe1-63cd-43b2-a6cd-00c5c9b189da}"/>
        <rule symbol="1" label="Moderate" description="Moderate" filter="GRIDCODE = '2'" key="{fb24d704-7ed2-43f3-8aa2-d9dad571978e}"/>
        <rule symbol="2" label="Low" description="Low" filter="GRIDCODE = '1'" key="{97376c02-81c7-4589-b234-e59539068b34}"/>
      </rule>
      <rule symbol="3" label="&lt;all other values>" description="&lt;all other values>" checkstate="0" filter="ELSE" key="{6f6bbb8f-ba03-4b1e-a556-d718a0769fc4}"/>
    </rules>
    <symbols>
      <symbol name="0" alpha="1" force_rhr="0" type="fill" clip_to_extent="1">
        ...
        <layer pass="0" locked="0" class="SimpleFill" enabled="1">
          <Option type="Map">
            ...
            <Option name="color" value="230,152,0,255" type="QString"/>
      ...
      <symbol name="1" alpha="1" force_rhr="0" type="fill" clip_to_extent="1">
        ...
        <layer pass="0" locked="0" class="SimpleFill" enabled="1">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="color" value="230,230,0,255" type="QString"/>
            <Option name="joinstyle" value="bevel" type="QString"/>
            <Option name="offset" value="0,0" type="QString"/>
            <Option name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="offset_unit" value="MM" type="QString"/>
            <Option name="outline_color" value="130,130,130,255" type="QString"/>
            <Option name="outline_style" value="solid" type="QString"/>
            <Option name="outline_width" value="0" type="QString"/>
            <Option name="outline_width_unit" value="Point" type="QString"/>
            <Option name="style" value="solid" type="QString"/>
      ...
      <symbol name="3" alpha="1" force_rhr="0" type="fill" clip_to_extent="1">
        ...
        <layer pass="0" locked="0" class="SimpleFill" enabled="1">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="color" value="224,252,194,255" type="QString"/>
            <Option name="joinstyle" value="bevel" type="QString"/>
            <Option name="offset" value="0,0" type="QString"/>
            <Option name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="offset_unit" value="MM" type="QString"/>
          ...
          <prop v="3x:0,0,0,0,0,0" k="border_width_map_unit_scale"/>
          <prop v="224,252,194,255" k="color"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="0,0" k="offset"/>
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MM" k="offset_unit"/>
