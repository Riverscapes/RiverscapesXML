...
<qgis styleCategories="Symbology" version="3.40.4-Bratislava">
  <renderer-v2 type="graduatedSymbol" symbollevels="0" attr="fishPerM2" graduatedMethod="GraduatedColor" referencescale="-1" forceraster="0" enableorderby="0">
    <ranges>
      <range render="true" label="0.00027 - 0.00078" symbol="0" uuid="{88e9ba82-911c-4f05-9cf7-9e865456566d}" lower="0.000271768678201" upper="0.000779004920113"/>
      <range render="true" label="0.00078 - 0.00126" symbol="1" uuid="{21b0682b-7766-4b98-b1d6-a75c4ac952e5}" lower="0.000779004920113" upper="0.001263947972649"/>
      <range render="true" label="0.00126 - 0.00214" symbol="2" uuid="{4255475b-5139-48e2-88ff-7acb67b7c8e4}" lower="0.001263947972649" upper="0.002135206318008"/>
      <range render="true" label="0.00214 - 0.00373" symbol="3" uuid="{a18e5bc7-dab4-41ec-9eb6-5cc03572e301}" lower="0.002135206318008" upper="0.003733318574006"/>
      <range render="true" label="0.00373 - 0.01523" symbol="4" uuid="{a90f120e-e7dd-4ea8-8a11-46fb66e305ac}" lower="0.003733318574006" upper="0.015226775325687"/>
    </ranges>
    <symbols>
      <symbol type="marker" name="0" force_rhr="0" frame_rate="10" clip_to_extent="1" alpha="1" is_animated="0">
        ...
        <layer class="SimpleMarker" locked="0" pass="0" enabled="1" id="{34535ceb-2cef-4c2d-b97b-f8a2729993f4}">
          <Option type="Map">
      ...
      <symbol type="marker" name="4" force_rhr="0" frame_rate="10" clip_to_extent="1" alpha="1" is_animated="0">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" name="name" value=""/>
            <Option name="properties"/>
    ...
    <classificationMethod id="Quantile">
      ...
      <labelFormat format="%1 - %2" labelprecision="5" trimtrailingzeroes="1"/>
      <parameters>
        <Option/>
      </parameters>
      <extraInformation/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol type="marker" name="" force_rhr="0" frame_rate="10" clip_to_extent="1" alpha="1" is_animated="0">
        ...
        <layer class="SimpleMarker" locked="0" pass="0" enabled="1" id="{19cfce8e-dff9-46a5-af85-628c2b8ddd04}">
          <Option type="Map">
            <Option type="QString" name="angle" value="0"/>
            <Option type="QString" name="cap_style" value="square"/>
