...
<qgis styleCategories="Symbology" version="3.40.4-Bratislava">
  <renderer-v2 type="graduatedSymbol" symbollevels="0" attr="fishPerM2" graduatedMethod="GraduatedColor" referencescale="-1" forceraster="0" enableorderby="0">
    <ranges>
      <range render="true" label="0 - 0.11" symbol="0" uuid="{660dd972-dfe9-427a-814a-a66389109c25}" lower="0.000000000000000" upper="0.109782462512524"/>
      <range render="true" label="0.11 - 0.23" symbol="1" uuid="{c0cbd246-eb80-486f-b1b1-cf63dc59cd34}" lower="0.109782462512524" upper="0.229645683644494"/>
      <range render="true" label="0.23 - 0.33" symbol="2" uuid="{7f791cb3-65bc-4518-9240-27803aa290a6}" lower="0.229645683644494" upper="0.332993635736085"/>
      <range render="true" label="0.33 - 0.5" symbol="3" uuid="{6da7525e-9e17-4a96-beee-72f4bb3e6934}" lower="0.332993635736085" upper="0.503318543873741"/>
      <range render="true" label="0.5 - 9.41" symbol="4" uuid="{752bab46-a3d9-4293-a89c-6e3c840b53a8}" lower="0.503318543873741" upper="9.411398712470419"/>
    </ranges>
    <symbols>
