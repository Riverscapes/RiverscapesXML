...
<qgis styleCategories="Symbology" version="3.40.4-Bratislava">
  <renderer-v2 type="graduatedSymbol" symbollevels="0" attr="fishPerM2" graduatedMethod="GraduatedColor" referencescale="-1" forceraster="0" enableorderby="0">
    <ranges>
      <range render="true" label="0.0002 - 0.0014" symbol="0" uuid="{1bca150d-36a3-41db-9b5a-93694d34bc8a}" lower="0.000161602603923" upper="0.001415538652574"/>
      <range render="true" label="0.0014 - 0.003" symbol="1" uuid="{91d4cad4-773e-4c5e-822d-769f14dc5833}" lower="0.001415538652574" upper="0.002990506283756"/>
      <range render="true" label="0.003 - 0.0054" symbol="2" uuid="{71435433-3dd6-4da6-bc98-867d41fab6ec}" lower="0.002990506283756" upper="0.005368613054858"/>
      <range render="true" label="0.0054 - 0.0084" symbol="3" uuid="{c8d33f11-adad-4f86-8bfe-17b4f61779cc}" lower="0.005368613054858" upper="0.008439713197939"/>
      <range render="true" label="0.0084 - 0.0257" symbol="4" uuid="{64ee5190-70a9-43f7-a7db-8523c561f8b3}" lower="0.008439713197939" upper="0.025694042765928"/>
    </ranges>
    <symbols>
