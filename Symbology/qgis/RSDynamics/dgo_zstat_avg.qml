...
<qgis version="3.40.4-Bratislava" styleCategories="Symbology">
  <renderer-v2 referencescale="-1" attr="zstat_stdev" symbollevels="0" type="graduatedSymbol" enableorderby="0" forceraster="0" graduatedMethod="GraduatedColor">
    <ranges>
      <range upper="0.000000000000000" uuid="{8f54f27e-a989-45b3-ba1f-fdf91818d3b7}" label="0 - 0" render="true" lower="0.000000000000000" symbol="0"/>
      <range upper="0.000000000000000" uuid="{f77e3fff-24b1-4312-8955-4011564c04bc}" label="0 - 0" render="true" lower="0.000000000000000" symbol="1"/>
      <range upper="0.000000000000000" uuid="{42a10b7f-6f06-4255-9578-ebd79a61e073}" label="0 - 0" render="true" lower="0.000000000000000" symbol="2"/>
      <range upper="0.004034157676824" uuid="{fbfb1b88-6070-4c5b-af11-33ad202f9397}" label="0 - 0.004" render="true" lower="0.000000000000000" symbol="3"/>
      <range upper="0.438403846572200" uuid="{7ae8e8b0-8732-4a0c-b7c5-23ae5d565fcc}" label="0.004 - 0.4384" render="true" lower="0.004034157676824" symbol="4"/>
    </ranges>
    <symbols>
      <symbol is_animated="0" type="fill" frame_rate="10" force_rhr="0" name="0" alpha="1" clip_to_extent="1">
        ...
        <layer id="{11e2d2da-11e6-4914-9e31-31699d8016fa}" enabled="1" class="SimpleFill" pass="0" locked="0">
          <Option type="Map">
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol is_animated="0" type="fill" frame_rate="10" force_rhr="0" name="" alpha="1" clip_to_extent="1">
        ...
        <layer id="{e2ceca17-516b-4983-bcb6-1e05a5990ff7}" enabled="1" class="SimpleFill" pass="0" locked="0">
          <Option type="Map">
            <Option value="3x:0,0,0,0,0,0" type="QString" name="border_width_map_unit_scale"/>
