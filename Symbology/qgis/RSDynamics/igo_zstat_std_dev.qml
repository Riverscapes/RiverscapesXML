...
<qgis version="3.40.4-Bratislava" styleCategories="Symbology">
  <renderer-v2 referencescale="-1" attr="zstat_stdev" symbollevels="0" type="graduatedSymbol" enableorderby="0" forceraster="0" graduatedMethod="GraduatedColor">
    <ranges>
      <range upper="0.000000000000000" uuid="{044db50e-3355-4b4d-84a8-eeefcc24d195}" label="0 - 0" render="true" lower="0.000000000000000" symbol="0"/>
      <range upper="0.000000000000000" uuid="{46e28948-ab5e-4d1a-b5e9-ec40afcab1d4}" label="0 - 0" render="true" lower="0.000000000000000" symbol="1"/>
      <range upper="0.000000000000000" uuid="{2d1ae569-9540-4308-85ca-b62ded5dcef9}" label="0 - 0" render="true" lower="0.000000000000000" symbol="2"/>
      <range upper="0.004013131492325" uuid="{09b65e57-fb55-4300-b01e-025a197f64d5}" label="0 - 0.004" render="true" lower="0.000000000000000" symbol="3"/>
      <range upper="0.438403846572200" uuid="{190b1102-36d5-4e3a-9d7a-2042be782a1c}" label="0.004 - 0.4384" render="true" lower="0.004013131492325" symbol="4"/>
    </ranges>
    <symbols>
      <symbol is_animated="0" type="marker" frame_rate="10" force_rhr="0" name="0" alpha="1" clip_to_extent="1">
        ...
        <layer id="{810616c6-82bd-48a2-aa03-81306c05b0e3}" enabled="1" class="SimpleMarker" pass="0" locked="0">
          <Option type="Map">
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol is_animated="0" type="marker" frame_rate="10" force_rhr="0" name="" alpha="1" clip_to_extent="1">
        ...
        <layer id="{ea6c1120-cc7c-4553-b7a6-aad58b554d66}" enabled="1" class="SimpleMarker" pass="0" locked="0">
          <Option type="Map">
            <Option value="0" type="QString" name="angle"/>
            <Option value="square" type="QString" name="cap_style"/>
