...
<qgis version="3.40.4-Bratislava" styleCategories="Symbology">
  <renderer-v2 referencescale="-1" attr="zstat_min" symbollevels="0" type="graduatedSymbol" enableorderby="0" forceraster="0" graduatedMethod="GraduatedColor">
    <ranges>
      <range upper="0.000000000000000" uuid="{a5f8cd35-e33f-4e21-ab77-a4caa57a422a}" label="0 - 0" render="true" lower="0.000000000000000" symbol="0"/>
      <range upper="0.000000000000000" uuid="{6a416976-ea84-482e-bb94-00a2a1828396}" label="0 - 0" render="true" lower="0.000000000000000" symbol="1"/>
      <range upper="0.013888888992369" uuid="{85f7a32e-08b4-4453-817f-3f34579b426a}" label="0 - 0.014" render="true" lower="0.000000000000000" symbol="2"/>
      <range upper="0.043478261679411" uuid="{255b29bb-7ffe-40d8-9b46-802ff4c092b6}" label="0.014 - 0.043" render="true" lower="0.013888888992369" symbol="3"/>
      <range upper="1.000000000000000" uuid="{91281f6f-ec24-4b90-b328-d236e9b02121}" label="0.043 - 1" render="true" lower="0.043478261679411" symbol="4"/>
    </ranges>
    <symbols>
      <symbol is_animated="0" type="fill" frame_rate="10" force_rhr="0" name="0" alpha="1" clip_to_extent="1">
        ...
        <layer id="{7ede21cd-73fa-4254-8a71-76020bc33867}" enabled="1" class="SimpleFill" pass="0" locked="0">
          <Option type="Map">
      ...
      <symbol is_animated="0" type="fill" frame_rate="10" force_rhr="0" name="1" alpha="1" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
      ...
      <symbol is_animated="0" type="fill" frame_rate="10" force_rhr="0" name="2" alpha="1" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
      ...
      <symbol is_animated="0" type="fill" frame_rate="10" force_rhr="0" name="3" alpha="1" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
      ...
      <symbol is_animated="0" type="fill" frame_rate="10" force_rhr="0" name="4" alpha="1" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol is_animated="0" type="fill" frame_rate="10" force_rhr="0" name="" alpha="1" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
        ...
        <layer id="{acf38fa6-dca3-4660-8168-4e06610b8720}" enabled="1" class="SimpleFill" pass="0" locked="0">
          <Option type="Map">
            <Option value="3x:0,0,0,0,0,0" type="QString" name="border_width_map_unit_scale"/>
