...
<qgis version="3.40.4-Bratislava" styleCategories="Symbology">
  <renderer-v2 referencescale="-1" attr="zstat_min" symbollevels="0" type="graduatedSymbol" enableorderby="0" forceraster="0" graduatedMethod="GraduatedColor">
    <ranges>
      <range upper="0.000000000000000" uuid="{4c3d3295-00a1-4741-8a59-42f78057f8cc}" label="0 - 0" render="true" lower="0.000000000000000" symbol="0"/>
      <range upper="0.000000000000000" uuid="{b2a113d2-8e06-4316-afa0-1dd49641057f}" label="0 - 0" render="true" lower="0.000000000000000" symbol="1"/>
      <range upper="0.012820512987673" uuid="{e1799124-c763-4d58-a0d9-0129f497823a}" label="0 - 0.013" render="true" lower="0.000000000000000" symbol="2"/>
      <range upper="0.042553190141916" uuid="{6e13a7bc-319c-4d69-ac0d-203fb13e7f56}" label="0.013 - 0.043" render="true" lower="0.012820512987673" symbol="3"/>
      <range upper="1.000000000000000" uuid="{f35f178e-0ad6-4c4c-a909-2972aeb1aef2}" label="0.043 - 1" render="true" lower="0.042553190141916" symbol="4"/>
    </ranges>
    <symbols>
      <symbol is_animated="0" type="marker" frame_rate="10" force_rhr="0" name="0" alpha="1" clip_to_extent="1">
        ...
        <layer id="{6e45b0b1-3db9-4ba7-823f-9345db08cc23}" enabled="1" class="SimpleMarker" pass="0" locked="0">
          <Option type="Map">
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol is_animated="0" type="marker" frame_rate="10" force_rhr="0" name="" alpha="1" clip_to_extent="1">
        ...
        <layer id="{81c60d2e-0755-4d42-804e-caefa5c97f67}" enabled="1" class="SimpleMarker" pass="0" locked="0">
          <Option type="Map">
            <Option value="0" type="QString" name="angle"/>
            <Option value="square" type="QString" name="cap_style"/>
