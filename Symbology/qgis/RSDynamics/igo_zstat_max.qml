...
<qgis version="3.40.4-Bratislava" styleCategories="Symbology">
  <renderer-v2 referencescale="-1" attr="zstat_max" symbollevels="0" type="graduatedSymbol" enableorderby="0" forceraster="0" graduatedMethod="GraduatedColor">
    <ranges>
      <range upper="0.000000000000000" uuid="{78f27aa3-686e-47b7-8222-223907baac78}" label="0 - 0" render="true" lower="0.000000000000000" symbol="0"/>
      <range upper="0.000000000000000" uuid="{b1d701f9-6ef3-417d-bbc2-a3935fe86d32}" label="0 - 0" render="true" lower="0.000000000000000" symbol="1"/>
      <range upper="0.020979020744562" uuid="{3263200f-2d20-448a-9dae-8c8911e128ad}" label="0 - 0.021" render="true" lower="0.000000000000000" symbol="2"/>
      <range upper="0.056603774428368" uuid="{ca82868e-b638-4dd2-92ca-e6f10bcb9616}" label="0.021 - 0.057" render="true" lower="0.020979020744562" symbol="3"/>
      <range upper="1.000000000000000" uuid="{c9782a11-d2e0-436c-819d-e3beb739cec2}" label="0.057 - 1" render="true" lower="0.056603774428368" symbol="4"/>
    </ranges>
    <symbols>
      <symbol is_animated="0" type="marker" frame_rate="10" force_rhr="0" name="0" alpha="1" clip_to_extent="1">
        ...
        <layer id="{a461b5c4-df07-4b97-932f-76096c3141cf}" enabled="1" class="SimpleMarker" pass="0" locked="0">
          <Option type="Map">
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol is_animated="0" type="marker" frame_rate="10" force_rhr="0" name="" alpha="1" clip_to_extent="1">
        ...
        <layer id="{f47b2a15-e0e2-4861-aeb2-802848681c14}" enabled="1" class="SimpleMarker" pass="0" locked="0">
          <Option type="Map">
            <Option value="0" type="QString" name="angle"/>
            <Option value="square" type="QString" name="cap_style"/>
