...
<qgis styleCategories="Symbology" version="3.40.4-Bratislava">
  <renderer-v2 referencescale="-1" enableorderby="0" symbollevels="0" type="singleSymbol" forceraster="0">
    <symbols>
      <symbol name="0" alpha="1" force_rhr="0" is_animated="0" clip_to_extent="1" frame_rate="10" type="fill">
        ...
        <layer locked="0" enabled="1" class="SimpleLine" pass="0" id="{01820e50-cfa6-4529-a4d0-817df13799b8}">
          <Option type="Map">
            ...
            <Option value="255,246,0,255,hsv:0.16086111111111112,1,1,1" name="line_color" type="QString"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol name="" alpha="1" force_rhr="0" is_animated="0" clip_to_extent="1" frame_rate="10" type="fill">
        ...
        <layer locked="0" enabled="1" class="SimpleFill" pass="0" id="{89c8d004-3ccc-4a93-82dd-fe56a597037f}">
          <Option type="Map">
