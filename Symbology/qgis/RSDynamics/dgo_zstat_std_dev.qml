...
<qgis version="3.40.4-Bratislava" styleCategories="Symbology">
  <renderer-v2 referencescale="-1" attr="zstat_stdev" symbollevels="0" type="graduatedSymbol" enableorderby="0" forceraster="0" graduatedMethod="GraduatedColor">
    <ranges>
      <range upper="0.000000000000000" uuid="{5e364bef-a34d-4d2b-ba8c-6ca2958afed5}" label="0 - 0" render="true" lower="0.000000000000000" symbol="0"/>
      <range upper="0.000000000000000" uuid="{08dd356b-a34f-4fe4-b635-f38d6cae4393}" label="0 - 0" render="true" lower="0.000000000000000" symbol="1"/>
      <range upper="0.000000000000000" uuid="{869f4aa0-b4ab-43b2-940f-c4f4ee239452}" label="0 - 0" render="true" lower="0.000000000000000" symbol="2"/>
      <range upper="0.004034157676824" uuid="{287199e5-f858-43ca-b451-8f876eb0b892}" label="0 - 0.004" render="true" lower="0.000000000000000" symbol="3"/>
      <range upper="0.438403846572200" uuid="{42f3fa8f-6ed5-4cfe-941e-2152a2e5a7e4}" label="0.004 - 0.4384" render="true" lower="0.004034157676824" symbol="4"/>
    </ranges>
    <symbols>
      <symbol is_animated="0" type="fill" frame_rate="10" force_rhr="0" name="0" alpha="1" clip_to_extent="1">
        ...
        <layer id="{56a68bf0-1e1e-4611-b3fc-c189ff2961ff}" enabled="1" class="SimpleFill" pass="0" locked="0">
          <Option type="Map">
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol is_animated="0" type="fill" frame_rate="10" force_rhr="0" name="" alpha="1" clip_to_extent="1">
        ...
        <layer id="{c743c96d-3487-44f2-af90-ed7fb7a61d6f}" enabled="1" class="SimpleFill" pass="0" locked="0">
          <Option type="Map">
            <Option value="3x:0,0,0,0,0,0" type="QString" name="border_width_map_unit_scale"/>
