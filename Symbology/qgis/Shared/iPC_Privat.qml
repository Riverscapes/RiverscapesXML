...
<qgis version="3.20.0-Odense" simplifyDrawingHints="1" labelsEnabled="0" simplifyAlgorithm="0" maxScale="0" simplifyMaxScale="1" readOnly="0" simplifyDrawingTol="1" minScale="100000000" simplifyLocal="1" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0">
  ...
  <renderer-v2 enableorderby="0" forceraster="0" type="graduatedSymbol" attr="iPC_Privat" graduatedMethod="GraduatedColor" symbollevels="0">
    <ranges>
      <range render="true" upper="1500.000999999999976" lower="0.000000000000000" symbol="0" label="Within range of established colony (0 - 1.5 km)"/>
      <range render="true" upper="12000.001000000000204" lower="1500.000999999999976" symbol="1" label="Within range of post-translocation movements (1.5 - 12 km)"/>
      <range render="true" upper="10000000000.000000000000000" lower="12000.001000000000204" symbol="2" label="Beaver less likely to move this far (> 12 km)"/>
    </ranges>
    <symbols>
