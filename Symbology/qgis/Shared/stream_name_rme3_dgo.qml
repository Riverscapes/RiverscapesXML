...
<qgis version="3.40.4-Bratislava" styleCategories="LayerConfiguration|Symbology|Labeling" readOnly="0" labelsEnabled="1">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="singleSymbol" referencescale="-1" enableorderby="0">
    <symbols>
      <symbol type="fill" frame_rate="10" force_rhr="0" is_animated="0" alpha="1" name="0" clip_to_extent="1">
        ...
        <layer pass="0" locked="0" id="{4a1102a1-0daa-43ab-9d0e-15e392a03abc}" class="SimpleFill" enabled="1">
          <Option type="Map">
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol type="fill" frame_rate="10" force_rhr="0" is_animated="0" alpha="1" name="" clip_to_extent="1">
        ...
        <layer pass="0" locked="0" id="{09996904-bd84-40c9-8b23-65705911b30b}" class="SimpleFill" enabled="1">
          <Option type="Map">
            <Option type="QString" value="3x:0,0,0,0,0,0" name="border_width_map_unit_scale"/>
  ...
  <labeling type="rule-based">
    <rules key="{8d263423-6799-483d-98f3-09bfd3fff6fc}">
      <rule description="High Order Perennial, zoomed out" key="{3222ee42-7714-4043-9a37-96a83dd25349}" filter="&quot;FCode&quot; = 46006 AND &quot;stream_order&quot; >= (maximum(&quot;stream_order&quot;) - 1)">
      ...
      <rule description="High Order Perennial, Zoomed In" key="{c851ef6c-6fe8-4a93-9cba-0d5e49a291d3}" filter="&quot;FCode&quot; = 46006 AND &quot;stream_order&quot; >= (maximum(&quot;stream_order&quot;) - 1)">
        <settings calloutType="simple">
      ...
      <rule description="Low Order Perennial" key="{3cbe3adc-bb03-4bcc-84d1-56802d8e872d}" filter="&quot;FCode&quot; = 46006 AND &quot;stream_order&quot; &lt; (maximum(&quot;stream_order&quot;) - 1)">
        <settings calloutType="simple">
