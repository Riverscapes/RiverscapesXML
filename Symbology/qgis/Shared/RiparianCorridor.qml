...
<qgis hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" version="3.16.8-Hannover" minScale="0" maxScale="0">
  ...
  <pipe>
    ...
    <rasterrenderer alphaBand="-1" opacity="0.6" nodataColor="" band="1" type="paletted">
      ...
      <colorPalette>
        <paletteEntry alpha="255" value="1" color="#4ce600" label="Historic OR Existing Riparian"/>
        <paletteEntry alpha="255" value="2" color="#267300" label="Historic AND Existing Riparian"/>
      </colorPalette>
