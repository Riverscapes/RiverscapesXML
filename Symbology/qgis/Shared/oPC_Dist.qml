...
<qgis version="3.20.0-Odense" simplifyDrawingHints="1" labelsEnabled="0" simplifyAlgorithm="0" maxScale="0" simplifyMaxScale="1" readOnly="0" simplifyDrawingTol="1" minScale="100000000" simplifyLocal="1" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0">
  ...
  <renderer-v2 enableorderby="0" forceraster="0" type="graduatedSymbol" attr="oPC_Dist" graduatedMethod="GraduatedColor" symbollevels="0">
    <ranges>
      <range render="true" upper="30.001000000000001" lower="0.000000000000000" symbol="0" label="Immediately Adjacent (0 - 30 m)"/>
      <range render="true" upper="100.000100000000003" lower="30.001000000000001" symbol="1" label="Within Normal Forage Range (30 - 100 m)"/>
      <range render="true" upper="300.000999999999976" lower="100.000100000000003" symbol="2" label="Within Plausible Forage range (100 - 300 m)"/>
      ...
      <range render="true" upper="10000000.000000000000000" lower="1000.000999999999976" symbol="4" label="Not Close (> 1 km)"/>
    </ranges>
    <symbols>
