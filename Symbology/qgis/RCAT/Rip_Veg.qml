...
<qgis hasScaleBasedVisibilityFlag="0" version="3.28.1-Firenze" styleCategories="AllStyleCategories" maxScale="0" minScale="0">
  <flags>
  ...
  <pipe>
    ...
    <rasterrenderer band="1" type="paletted" alphaBand="-1" nodataColor="" opacity="1">
      ...
      <colorPalette>
        <paletteEntry alpha="255" color="#ffffff" label="Non-Riparian " value="0"/>
        <paletteEntry alpha="255" color="#38a800" label="Riparian " value="1"/>
      </colorPalette>
